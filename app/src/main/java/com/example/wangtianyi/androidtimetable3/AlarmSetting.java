...
public class AlarmSetting extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.ring_rl:
                ...
                break;
            case R.id.set_btn:
                String note = getIntent().getStringExtra("thing");
                setClock(note);
                break;
            default:
                break;
            ...
            if (cycle == 0) {//是每天的闹钟
                ...
                for (int i = 0; i < weeks.length; i++) {
                    AlarmManagerUtil.setAlarm(this, 2, Integer.parseInt(times[0]), Integer
                            .parseInt(times[1]), i, Integer.parseInt(weeks[i]), str, ring);
                }
            }
